%保持上一时刻采样值
function [y11,y12,y13,u11,u12,u13]=DMC5(controller)
...
V=controller.V;
%依次读取神经网络填充好的阶跃响应系数
m1=load("D:/EI/dmc_code/N_10/y_total1.mat");
m2=load("D:/EI/dmc_code/N_10/y_total2.mat");
m3=load("D:/EI/dmc_code/N_10/y_total3.mat");
m4=load("D:/EI/dmc_code/N_10/y_total4.mat");
m5=load("D:/EI/dmc_code/N_10/y_total5.mat");
m6=load("D:/EI/dmc_code/N_10/y_total6.mat");
m7=load("D:/EI/dmc_code/N_10/y_total7.mat");
m8=load("D:/EI/dmc_code/N_10/y_total8.mat");
m9=load("D:/EI/dmc_code/N_10/y_total9.mat");
%赋值给对应的阶跃响应系统
