...
% 增益失配30%
p13=poly2tfd(5.88*0.7,[50 1],0,27);pmodel13=tfd2step(tfinal,delt,1,g13);pmodel{1,3}=pmodel13(1:N);
...
q11=poly2tfd(4.05,[50 1],0,27);qmodel11=tfd2step(tfinal,delt,1,g11);qmodel{1,1}=qmodel11(1:N);
q12=poly2tfd(1.77,[60 1],0,28);qmodel12=tfd2step(tfinal,delt,1,g12);qmodel{1,2}=qmodel12(1:N);
% 增益失配20%
q13=poly2tfd(5.88*0.8,[50 1],0,27);qmodel13=tfd2step(tfinal,delt,1,g13);qmodel{1,3}=qmodel13(1:N);
q21=poly2tfd(5.39,[50 1],0,18);qmodel21=tfd2step(tfinal,delt,1,g21);qmodel{2,1}=qmodel21(1:N);
q22=poly2tfd(5.72,[60 1],0,14);qmodel22=tfd2step(tfinal,delt,1,g22);qmodel{2,2}=qmodel22(1:N);
q23=poly2tfd(6.09,[40 1],0,15);qmodel23=tfd2step(tfinal,delt,1,g23);qmodel{2,3}=qmodel23(1:N);
q31=poly2tfd(4.38,[33 1],0,20);qmodel31=tfd2step(tfinal,delt,1,g31);qmodel{3,1}=qmodel31(1:N);
q32=poly2tfd(4.42,[44 1],0,22);qmodel32=tfd2step(tfinal,delt,1,g32);qmodel{3,2}=qmodel32(1:N);
q33=poly2tfd(7.20,[19 1],0,0);qmodel33=tfd2step(tfinal,delt,1,g33);qmodel{3,3}=qmodel33(1:N);

r11=poly2tfd(4.05,[50 1],0,27);rmodel11=tfd2step(tfinal,delt,1,g11);rmodel{1,1}=rmodel11(1:N);
r12=poly2tfd(1.77,[60 1],0,28);rmodel12=tfd2step(tfinal,delt,1,g12);rmodel{1,2}=rmodel12(1:N);
% 增益失配10%
r13=poly2tfd(5.88*0.9,[50 1],0,27);rmodel13=tfd2step(tfinal,delt,1,g13);rmodel{1,3}=rmodel13(1:N);
r21=poly2tfd(5.39,[50 1],0,18);rmodel21=tfd2step(tfinal,delt,1,g21);rmodel{2,1}=rmodel21(1:N);
r22=poly2tfd(5.72,[60 1],0,14);rmodel22=tfd2step(tfinal,delt,1,g22);rmodel{2,2}=rmodel22(1:N);
r23=poly2tfd(6.09,[40 1],0,15);rmodel23=tfd2step(tfinal,delt,1,g23);rmodel{2,3}=rmodel23(1:N);
r31=poly2tfd(4.38,[33 1],0,20);rmodel31=tfd2step(tfinal,delt,1,g31);rmodel{3,1}=rmodel31(1:N);
r32=poly2tfd(4.42,[44 1],0,22);rmodel32=tfd2step(tfinal,delt,1,g32);rmodel{3,2}=rmodel32(1:N);
r33=poly2tfd(7.20,[19 1],0,0);rmodel33=tfd2step(tfinal,delt,1,g33);rmodel{3,3}=rmodel33(1:N);
...
[y41,y42,y43,u41,u42,u43]=DMC3(controller4);
...
[y51,y52,y53,u51,u52,u53]=DMC7(controller5);
...
[y61,y62,y63,u61,u62,u63]=DMC8(controller6);
...
ylabel('y1 error');
xlabel('t/min');
legend('增益失配程度30%','增益失配程度20%','增益失配程度10%','参考轨迹','location','best');
title('二次样条插值 10T0')
